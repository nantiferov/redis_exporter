...
func main() {
	var (
		...
		redisMetricsOnly               = flag.Bool("redis-only-metrics", getEnvBool("REDIS_EXPORTER_REDIS_ONLY_METRICS", false), "Whether to export only Redis metrics (omit Go runtime metrics)")
		extendedGoMetrics              = flag.Bool("extended-go-metrics", getEnvBool("REDIS_EXPORTER_EXTENDED_GO_METRICS", false), "Whether to export all Go runtime metrics")
	...
	registry := createPrometheusRegistry(*redisMetricsOnly, *extendedGoMetrics)
